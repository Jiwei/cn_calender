const { MONTH_NAMES, LUNAR_HOLIDAYS } = require('./constants');

// Get lunar-javascript globals (set by the page before requiring this module)
const { Lunar, Solar, LunarMonth, LunarYear } = global;
